...
var _user$project$Retrospective_Model$model = function () {
	var dummyData = {
		ctor: '::',
		_0: A3(_user$project$Retrospective_Model$Idea, 'hello', _user$project$Retrospective_Model$Start, 0),
		_1: {
			ctor: '::',
			_0: A3(_user$project$Retrospective_Model$Idea, 'world', _user$project$Retrospective_Model$Continue, 1),
			_1: {
				ctor: '::',
				_0: A3(_user$project$Retrospective_Model$Idea, 'foobar', _user$project$Retrospective_Model$Stop, 0),
				_1: {ctor: '[]'}
			}
		}
	};
...
var _user$project$Retrospective_Model$ToggleVoting = {ctor: 'ToggleVoting'};
	...
	function (model, i) {
		var ideas = _elm_lang$core$Tuple$second(
			A2(
				...
				function (x) {
					return _elm_lang$core$Native_Utils.eq(x, i);
				},
				model.ideas));
		return _elm_lang$core$Native_Utils.update(
			model,
...
var _user$project$Retrospective_View$onEnter = function (msg) {
			...
			_0: A2(
				_elm_lang$html$Html$button,
				{
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Retrospective_Model$MinusScore(i)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
						...
						_0: _elm_lang$html$Html$text(
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									' - ',
									_elm_lang$core$Basics$toString(i.score)))),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$button,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Retrospective_Model$PlusScore(i)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Retrospective_View$editableIdea = function (i) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(i.note),
			_1: {ctor: '[]'}
		});
};
var _user$project$Retrospective_View$renderIdea = F2(
	function (voting, i) {
		var _p1 = voting;
		if (_p1 === true) {
			return _user$project$Retrospective_View$votableIdea(i);
		} else {
			return _user$project$Retrospective_View$editableIdea(i);
		}
	});
var _user$project$Retrospective_View$ideaList = F2(
	function (ideas, voting) {
		return A2(
			_elm_lang$html$Html$ol,
			{ctor: '[]'},
			A2(
				_elm_lang$core$List$map,
				_user$project$Retrospective_View$renderIdea(voting),
				ideas));
	});
var _user$project$Retrospective_View$ideaSection = function (model) {
	var continueIdeas = A2(
		_elm_lang$core$List$filter,
		function (i) {
			return _elm_lang$core$Native_Utils.eq(i.kind, _user$project$Retrospective_Model$Continue);
		},
		model.ideas);
	var stopIdeas = A2(
		_elm_lang$core$List$filter,
		function (i) {
			return _elm_lang$core$Native_Utils.eq(i.kind, _user$project$Retrospective_Model$Stop);
		},
		model.ideas);
	var startIdeas = A2(
		_elm_lang$core$List$filter,
		function (i) {
			return _elm_lang$core$Native_Utils.eq(i.kind, _user$project$Retrospective_Model$Start);
		},
		model.ideas);
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_user$project$Retrospective_View$ideaList, startIdeas, model.voting),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Retrospective_View$ideaList, stopIdeas, model.voting),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Retrospective_View$ideaList, continueIdeas, model.voting),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Retrospective_View$votingButton = function (voting) {
	var buttonText = voting ? 'Stop Voting' : 'Start Voting';
	return A2(
		_elm_lang$html$Html$button,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(_user$project$Retrospective_Model$ToggleVoting),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Retrospective_View$body = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Retrospective_View$ideaBox(model),
			_1: {
				ctor: '::',
				_0: _user$project$Retrospective_View$votingButton(model.voting),
				_1: {
					ctor: '::',
					_0: _user$project$Retrospective_View$ideaSection(model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Retrospective_View$header = A2(
	_elm_lang$html$Html$h1,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Retrospective!'),
		_1: {ctor: '[]'}
	});
var _user$project$Retrospective_View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Retrospective_View$header,
			_1: {
				ctor: '::',
				_0: _user$project$Retrospective_View$body(model),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Main$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Retrospective_Model$model, view: _user$project$Retrospective_View$view, update: _user$project$Retrospective_Update$update})();
